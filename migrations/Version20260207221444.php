 ...
 */
final class Version20260207221444 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etudiants (id SERIAL NOT NULL, cin_id INT DEFAULT NULL, bacc_id INT NOT NULL, sexe_id INT NOT NULL, nationalite_id INT DEFAULT NULL, nom VARCHAR(255) DEFAULT NULL, prenom VARCHAR(255) DEFAULT NULL, date_naissance TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, lieu_naissance VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE niveau_etudiants (id SERIAL NOT NULL, niveau_id INT DEFAULT NULL, mention_id INT NOT NULL, etudiant_id INT NOT NULL, status_etudiant_id INT DEFAULT NULL, annee INT NOT NULL, date_insertion TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, matricule VARCHAR(255) DEFAULT NULL, is_boursier INT DEFAULT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE propos (id SERIAL NOT NULL, etudiant_id INT NOT NULL, adresse VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, date_insertion TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, telephone VARCHAR(100) DEFAULT NULL, nom_pere VARCHAR(100) DEFAULT NULL, nom_mere VARCHAR(100) DEFAULT NULL, PRIMARY KEY(id))');
