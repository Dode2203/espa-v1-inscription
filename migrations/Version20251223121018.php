 ...
 */
final class Version20251223121018 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE droits (id SERIAL NOT NULL, type_droit_id INT NOT NULL, reference VARCHAR(255) NOT NULL, date_versement TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, montant DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_7A9D4CE9756148C ON droits (type_droit_id)');
        $this->addSql('CREATE TABLE ecolages (id SERIAL NOT NULL, formations_id INT NOT NULL, montant DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE formation_etudiants (id SERIAL NOT NULL, etudiants_id INT NOT NULL, formation_id INT NOT NULL, dateformation TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_E8015236A873A5C6 ON formation_etudiants (etudiants_id)');
        ...
        $this->addSql('CREATE TABLE niveau_etudiants (id SERIAL NOT NULL, niveau_id INT NOT NULL, mention_id INT NOT NULL, annee INT NOT NULL, dateinsertion TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE niveaux (id SERIAL NOT NULL, nom VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE payements_ecolages (id SERIAL NOT NULL, etudiant_id INT NOT NULL, reference VARCHAR(255) NOT NULL, datepayements TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, montant DOUBLE PRECISION NOT NULL, tranche INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE formation_etudiants ADD CONSTRAINT FK_E8015236A873A5C6 FOREIGN KEY (etudiants_id) REFERENCES etudiants (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formation_etudiants DROP CONSTRAINT FK_E8015236A873A5C6');
